...
public final class SPUtils {
    ...
    private static final String DEFAULT_SP = "LingJu";
    private static SimpleArrayMap<String, SPUtils> SP_UTILS_MAP = new SimpleArrayMap<>();
    private SharedPreferences sp;
    private static IJsonParse iJsonParse = new GsonParse();
    ...
    public void put(String key, Object object) {
        put(key, iJsonParse.objectToJson(object));
    }
    ...
    public <T> T get(String key, Type clazz) {
        ...
        T t = null;
        try {
            t = iJsonParse.parseObject(json, clazz);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return t;
