 ...
 */
package com.seeyou.toolkit.thirdparty.baserecyclerview;
...
import com.seeyou.toolkit.base.DataSource;
import com.seeyou.toolkit.thirdparty.baserecyclerview.animation.AlphaInAnimation;
import com.seeyou.toolkit.thirdparty.baserecyclerview.animation.BaseAnimation;
import com.seeyou.toolkit.thirdparty.baserecyclerview.loadmore.LoadMoreView;
import com.seeyou.toolkit.thirdparty.baserecyclerview.loadmore.SimpleLoadMoreView;
import com.seeyou.toolkit.thirdparty.baserecyclerview.muti.MultiTypeDelegate;
 ...
 */
public abstract class BaseQuickAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> implements DataSource<T> {
    ...
    public void setEmptyView(View emptyView) {
        ...
        if (mEmptyLayout == null) {
            ...
            final RecyclerView.LayoutParams layoutParams = new LayoutParams(RecyclerView.LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT);
     ...
     * called the empty view. The empty view is used to provide feedback to the getUser
